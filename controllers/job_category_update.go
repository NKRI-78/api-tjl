...
func JobCategoryUpdate(w http.ResponseWriter, r *http.Request) {

	data := &models.JobCategoryUpdate{}
	...
	result, err := services.JobCategoryUpdate(data)
	...
	helper.Logger("info", "Update Job Category success")
